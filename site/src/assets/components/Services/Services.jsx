    ...
    return (
      <Fragment>
        <Container className='text-center'>
            ...
            <h1 className='serviceMainTitle text-uppercase'>My Services</h1>
            ...
            <Row>
                ...
                <Col lg={4} md={6} sm={12}>
                    <div className="serviceCard text-center">
                        <img src={ecommerceIcon} className="img-fluid ecommerceIcon" alt="" />
                ...
                <Col lg={4} md={6} sm={12}>
                   <div className="serviceCard text-center">
                        <img src={designIcon} className="img-fluid designIcon" alt="" />
                ...
                <Col lg={4} md={6} sm={12}>
                    <div className="serviceCard text-center">
                        <img src={webIcon} className="img-fluid webIcon" alt="" />
